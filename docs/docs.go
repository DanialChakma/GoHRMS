...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "HRMS Support",
            "url": "http://hrms.example.com/support",
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/attendance/checkin/{employee_id}": {
            "post": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.JobTitleListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.JobTitle"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.LeaveListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.PayrollListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.Payroll"
                        }
                    }
                ],
                "responses": {
        ...
        "/payrolls/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated payroll data",
                        "name": "payroll",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "models.Payroll": {
            ...
            "properties": {
                ...
                "month": {
                    "description": "could be first day of month",
                    "type": "string"
                },
                "net_salary": {
                    "type": "number"
